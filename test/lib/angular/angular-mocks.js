 ...
 *
 * <pre>
 *   regterAppDev = angular.module('regterAppDev', ['regterApp', 'ngMockE2E']);
 *   regterAppDev.run(function($httpBackend) {
...
window.jasmine && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('regterApplicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('regterApp', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('regterApplicationModule'));
   *
   *
